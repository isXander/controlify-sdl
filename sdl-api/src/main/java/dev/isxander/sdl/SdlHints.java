...
public interface SdlHints {
    ...
    ///
    /// See `SDL_HINT_AUDIO_ALSA_DEFAULT_PLAYBACK_DEVICE`.
    /// See `SDL_HINT_AUDIO_ALSA_DEFAULT_RECORDING_DEVICE`.
    /// @since This hint is available since SDL 3.2.0.
    ...
    ///
    /// See `SDL_HINT_AUDIO_ALSA_DEFAULT_RECORDING_DEVICE`.
    /// See `SDL_HINT_AUDIO_ALSA_DEFAULT_DEVICE`.
    /// @since This hint is available since SDL 3.2.0.
    ...
    /// This hint should be set before SDL is initialized.
    ///
    /// See `SDL_HINT_ROG_GAMEPAD_MICE_EXCLUDED`.
    /// @since This hint is available since SDL 3.2.0.
